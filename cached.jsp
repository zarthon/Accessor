...
//  System.out.println("This is query from cache page "+ request.getParameter("query"));
  String language =
  ...
  bean.LOG.info("cache request from " + request.getRemoteAddr()+"  "+ details.getValue("url") + "  " + request.getParameter("query") );
...
<a href="locale.jsp?<%=language%>"><img src="img/logo.png" width="144" height="30" border="0" ></a><span  style=" font-size:20px; color:#FF9966">CACHE</span>
<h3>
