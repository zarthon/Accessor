...
function writeUnicodeToTamBox(num)
{
			...
			{
				var pos = document.getElementById("transl1").selectionEnd;
				var text1 = "";
				var i=0; 
				var text2 ="";
				var lastPos = 0;
				for(i=0;i<pos;i++)
				{
					text1 = text1 + document.getElementById("transl1").value[i];
				}
				for(i=pos;i<document.getElementById("transl1").value.length;i++)
				{
					text2 = text2 + document.getElementById("transl1").value[i];
				}
				text1 = text1 + num + text2;
				document.getElementById("transl1").value = text1 ;
				document.getElementById("transl1").selectionStart = pos+1;
				document.getElementById("transl1").selectionEnd = pos+1;
				document.getElementById("transl1").focus(pos+1);
			}
			else
			{
				document.getElementById("transl1").focus(document.getElementById("transl1").caretPos);
				document.getElementById("transl1").caretPos = document.selection.createRange().duplicate();
				document.getElementById("transl1").caretPos.text = num;
...
{
	document.getElementById("transl1").focus(document.getElementById("transl1").caretPos);
	var temp = document.getElementById("transl1").value;
	document.getElementById("transl1").value = temp.substring(0,temp.length-1);
}
function Tamil_51()
{
	if(Tamresult==1)
...
{
	document.getElementById("transl1").value = window.opener.document.getElementById("text_Area").value;
}
function TamSubmit1()
{
	Tamresult = 1;
