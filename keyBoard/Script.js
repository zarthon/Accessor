...
else if(cur_lyr == 'lyr8')
{
 var Keydcode = e.keyCode ? e.keyCode : e.which;
  switch(Keydcode)
  {
     ...
     case 8:
     var id=document.getElementById("Gujbutt53");
     if(flag==0)
     {
     ...
     break;
	 case 20:
     var id=document.getElementById("Gujbutt54");
     if(flag==0)
     {
     id.style.borderColor="blue";
     flag=1;
	 ...
	 case 220:
     var id=document.getElementById("Gujbutt63");
     if(flag==0)
     {
     id.style.borderColor="blue";
     flag=1;
	 ...
	 case 91:
     var id=document.getElementById("Gujbutt57");
     if(flag==0)
     {
     id.style.borderColor="blue";
     flag=1;
	 ...
	 case 92:
     var id=document.getElementById("Gujbutt60");
     if(flag==0)
     {
	 ...
	 case 93:
     var id=document.getElementById("Gujbutt61");
     if(flag==0)
     {
     ...
     break;
     case 59:
     var id=document.getElementById("Gujbutt37");
     Mapping_37();
     if(flag==0)
     {
     ...
     var id1=document.getElementById("Gujbutt55");
     if(flag==0)
     {
     ...
     case 9://Tab
     var id=document.getElementById("Gujbutt15");
     Mapping_15();
      if(flag==0)
     {
     ...
     case 44://,
     var id=document.getElementById("Gujbutt47");
     Mapping_47();
     if(flag==0)
     {
     ...
     case 47://
     var id=document.getElementById("Gujbutt49");
     Mapping_49();
     if(flag==0)
     {
     ...
     case 96://
     var id=document.getElementById("Gujbutt1");
     Mapping_1();
     if(flag==0)
     {
     ...
     case 49:
     var id=document.getElementById("Gujbutt2");
     Mapping_2();
     if(flag==0)
     {
     ...
     case 50:
     var id=document.getElementById("Gujbutt3");
     Mapping_3();
     if(flag==0)
     {
     ...
     case 51:
     var id=document.getElementById("Gujbutt4");
     Mapping_4();
     if(flag==0)
     {
     ...
     case 52:
     var id=document.getElementById("Gujbutt5");
     Mapping_5();
     if(flag==0)
     {
     ...
     case 53:
     var id=document.getElementById("Gujbutt6");
     Mapping_6();
     if(flag==0)
     {
     ...
     case 54:
     var id=document.getElementById("Gujbutt7");
     Mapping_7();
     if(flag==0)
     {
     ...
     case 55:
     var id=document.getElementById("Gujbutt8");
     Mapping_8();
     if(flag==0)
     {
     ...
     case 56:
     var id=document.getElementById("Gujbutt9");
     Mapping_9();
     if(flag==0)
     {
     ...
     case 57:
     var id=document.getElementById("Gujbutt10");
     Mapping_10();
     if(flag==0)
     {
     ...
     case 48:
     var id=document.getElementById("Gujbutt11");
     Mapping_11();
     if(flag==0)
     {
     ...
     case 65://a
     var id=document.getElementById("Gujbutt28"); 
     Mapping_28();
     if(flag==0)
     {
     ...
     case 66://b
     var id=document.getElementById("Gujbutt44");
     Mapping_44();
     if(flag==0)
     {
     ...
     case 67://c
     var id=document.getElementById("Gujbutt42");
     Mapping_42();
     if(flag==0)
     {
     ...
     case 68://d
     var id=document.getElementById("Gujbutt30");
     Mapping_30();
     if(flag==0)
     {
     ...
     case 69://e
     var id=document.getElementById("Gujbutt18");
     Mapping_18();
     if(flag==0)
     {
     ...
     case 70://f
     var id=document.getElementById("Gujbutt31");
     Mapping_31();
     if(flag==0)
     {
     ...
     case 71://g
     var id=document.getElementById("Gujbutt32");
     Mapping_32();
     if(flag==0)
     {
     ...
     case 72://h
     var id=document.getElementById("Gujbutt33");
     Mapping_33();
     if(flag==0)
     {
     ...
     case 73://i
     var id=document.getElementById("Gujbutt23");
     Mapping_23();
     if(flag==0)
     {
     ...
     case 74://j
     var id=document.getElementById("Gujbutt34");
     Mapping_34();
     if(flag==0)
     {
     ...
     case 75://k 
     var id=document.getElementById("Gujbutt35");
     Mapping_35();
     if(flag==0)
     {
     ...
     case 76://l
     var id=document.getElementById("Gujbutt36");
     Mapping_36();
     if(flag==0)
     {
     ...
     case 77://m
     var id=document.getElementById("Gujbutt46");
     Mapping_46();
     if(flag==0)
     {
     ...
     case 78://n
     var id=document.getElementById("Gujbutt45");
     Mapping_45();
     if(flag==0)
     {
     ...
     case 79://o 
     var id=document.getElementById("Gujbutt24");
     Mapping_24();
     if(flag==0)
     {
     ...
     case 80://p
     var id=document.getElementById("Gujbutt25");
     Mapping_25();
     if(flag==0)
     {
     ...
     case 81://q
     var id=document.getElementById("Gujbutt16");
     Mapping_16();
     if(flag==0)
     {
     ...
     case 82://r
     var id=document.getElementById("Gujbutt19");
     Mapping_19();
     if(flag==0)
     {
     ...
     case 83://s
     var id=document.getElementById("Gujbutt29");
     Mapping_29();
     if(flag==0)
     {
     ...
     case 84://t
     var id=document.getElementById("Gujbutt20");
     Mapping_20();
     if(flag==0)
     {
     ...
     case 85://u
     var id=document.getElementById("Gujbutt22");
     Mapping_22();
     if(flag==0)
     {
     ...
     case 86://v
     var id=document.getElementById("Gujbutt43");
     Mapping_43();
     if(flag==0)
     {
     ...
     case 87://w
     var id=document.getElementById("Gujbutt17");
     Mapping_17();
     if(flag==0)
     {
     ...
     case 88://x
     var id=document.getElementById("Gujbutt41");
     Mapping_41();
     if(flag==0)
     {
     ...
     case 89://y
     var id=document.getElementById("Gujbutt21");
     Mapping_21();
     if(flag==0)
     {
     ...
     case 90://z
     var id=document.getElementById("Gujbutt40");
     Mapping_40();
     if(flag==0)
     {
     ...
     case 189://z
     var id=document.getElementById("Gujbutt12");
     Mapping_12();
     if(flag==0)
     {
     ...
     break;
     case 187://z
     var id=document.getElementById("Gujbutt13");
     Mapping_13();
     if(flag==0)
     {
     ...
     case 219://z
     var id=document.getElementById("Gujbutt26");
     Mapping_26();
     if(flag==0)
     {
     ...
     break;
     case 221://z
     var id=document.getElementById("Gujbutt27");
     Mapping_14();
     if(flag==0)
     {
     ...
     case 222://z
     var id=document.getElementById("Gujbutt38");
     Mapping_38();
     if(flag==0)
     {
     ...
     case 13://z
     var id=document.getElementById("Gujbutt39");
     Mapping_39();
     if(flag==0)
     {
     ...
     case 190://z
     var id=document.getElementById("Gujbutt48");
     Mapping_48();
     if(flag==0)
     {
     ...
     case 32://z
     var id=document.getElementById("Gujbutt51");
     Mapping_51();
     if(flag==0)
     {
...
function SupressTextEcho(e) 
{
    ...
    {
        if(trimAll(document.getElementById("textfield").value) == "")
        return false;
        return true;
    }
...
function ShowNormalKeyboard()
{
	 ...
	 {
	   var varGujarati = new Array("Gujbutt15", "Gujbutt47", "Gujbutt48","Gujbutt49","Gujbutt29","Gujbutt45","Gujbutt43","Gujbutt31","Gujbutt18","Gujbutt32","Gujbutt33","Gujbutt34","Gujbutt23","Gujbutt35","Gujbutt36","Gujbutt37","Gujbutt46","Gujbutt24","Gujbutt25","Gujbutt16","Gujbutt19","Gujbutt30","Gujbutt20","Gujbutt22","Gujbutt44","Gujbutt17","Gujbutt42","Gujbutt21","Gujbutt1","Gujbutt2","Gujbutt3","Gujbutt4","Gujbutt5","Gujbutt6","Gujbutt7","Gujbutt8","Gujbutt9","Gujbutt10","Gujbutt11","Gujbutt12","Gujbutt13","Gujbutt26","Gujbutt27","Gujbutt28","Gujbutt38","Gujbutt39","Gujbutt40","Gujbutt41","Gujbutt51","Gujbutt52","Gujbutt53","Gujbutt54","Gujbutt55","Gujbutt56","Gujbutt57","Gujbutt58","Gujbutt59","Gujbutt60","Gujbutt61","Gujbutt62","Gujbutt63");

	   var cidG;
	     for(var i=0; i < varGujarati.length; i++)
	     {
			    cidG = document.getElementById(varGujarati[i]);
			    cidG.style.borderColor="";
	     }
	 }                                		
