...
//		String fig1 = "images/home_page/home_" + lang + "_seladv.jpeg";
		String fig1 = "images/result_page/result_" + lang + "_" + lang + ".jpeg";
		String fig2 = "images/result_page/result_" + lang + "_hi" + ".jpeg";
		String fig3 = "images/result_page/result_" + lang + "_en" + ".jpeg";
		String text1 = res.getString("oscreen_t1");
...
<span class="style8">Privacy Policy  </span>
	...
	<table cellpadding="30%" cellspacing="30%" align="center" width="80%">
		<tr>
		<td align="justify">
		<h4><%=res.getString("result")%> <%=res.getString("page")%> <%=res.getString("Help")%>:</h4><p>
		<%=text1%>
		</td>
		</tr>
		<tr>
