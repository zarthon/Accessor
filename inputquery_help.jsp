...
<head>
	...
	<%
        	String lang = request.getParameter("sessionlang"); // Session Language
                ...
                String text1 = res.getString("qscreen_t1");
                String text2 = res.getString("qscreen_t2");
                String text3 = res.getString("qscreen_t3");
                String text4 = res.getString("qscreen_t4");
                String text5 = res.getString("qscreen_t5");
                String text6 = res.getString("qscreen_t6");
                String text7 = res.getString("qscreen_t7");
